...
const Planet = () => {
  ...
  return (
    <main className="flex flex-col items-center gap-[42px] py-[80px] bg-[#FFE967]">
        ...
        <h2 className="container flex w-[500px] font-ultra2 text-[24px] text-center ">Grâce à l'utilisation des produits 900.care, pour une joyeuse tribu de 4 personnes et par an, c'est plus de :</h2>
